...
Es sollte hierbeit eine CMake-Version über 3.7.0 gewählt werden, und für das Projekt "Mandelbrot" werden alle
Dateien im Order include eingebunden. In diesem Ordner liegen die Header-Dateien für alle projektinternen C++-Quelldateien.
...
in die ausführbaren Dateien eingebunden.
