...
Einerseits soll die Bestimmung der Vorhersage nicht länger dauern als die Berechnung der Region selbst, andererseits muss die Vorhersage auch angemessen genau sein

Wie die naive Strategie, gibt es die Strategie mit Vorhersage in einer rekursiven und in einer nicht-rekursiven Variante.
