...
\end{equation}
Auch hier ist \verb|nodeCount| die Anzahl der Worker. Die Multiplikation mit 2 ist nötig, da nochmal $missing$ Blätter aufgeteilt werden müssen, um $missing$ zusätzliche Blätter zu erzeugen.
...
\begin{figure}[h!]
	\lstinputlisting[caption={Ubersetzung der}, label={src:RegionOfInterest.ts}, language=json, firstline=39, lastline=46, firstnumber=39]{../../frontend/src/tileDisplay/RegionOfInterest.ts}
\end{figure}
