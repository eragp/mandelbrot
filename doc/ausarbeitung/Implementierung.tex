...
einer Methode um Nachrichten des Clients zu behandeln, \verb|Host::handle_region_request|.
...
\verb|Klassenname::NAME| gespeichert. Ein Beispiel für einen Namen kann in \autoref{src:PredictionBalancer.NAME} gefunden werden:
