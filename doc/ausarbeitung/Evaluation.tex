...
Für die folgenden Messungen wurden immer 17 Worker verwendet.
...
\begin{figure}
	\centering
	\includegraphics[width=0.45\linewidth]{img/Evaluation/balancers/balancers_outside.png}
	\includegraphics[width=0.45\linewidth]{img/Evaluation/balancers/balancers_inside.png}
